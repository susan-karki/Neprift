...
const ProfileSettings = () => {
  const userId = localStorage.getItem("userId");
  const location = useLocation();
  const { activeSection } = useOutletContext(); // get from AdminLayout
  ...
  return (
    <div className="profile-container">
      ...
      {/* Only show User Info if activeSection === 'userinfo' */}
      ...
      {/* Only show Update Password if activeSection === 'updatepassword' */}
