...
const Payment = () => {
  ...
  useEffect(() => {
    ...
    const hashString =
      `total_amount=${totalAmount},transaction_uuid=${transaction_uuid},product_code=${product_code}`;
    ...
    const fields = {
      ...
      success_url: `http://localhost:5173/esewa-success?orderId=${orderId}&amount=${totalAmount}`,
